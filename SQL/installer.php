...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'InCuca_lawfirm_Claudemir_e4e22019b8db453d4848_20220911172839_archive.zip';
        const ARCHIVE_SIZE       = '127396403';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'e4e2201-11172839';
        const SECONDARY_PACKAGE_HASH = '5fdf975-11172839';
        const VERSION            = '1.5.0';
